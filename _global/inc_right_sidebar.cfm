            ...
            <li>
                <div class="timeline timeline_small uk-margin-bottom">
                    ...
                    <div class="timeline_item">
                        ...
                        <div class="timeline_content">Deleted post <a href="#"><strong>Rem iste ratione possimus sequi nobis voluptas consectetur.</strong></a></div>
                    </div>
                    <div class="timeline_item">
                    ...
                    <div class="timeline_item">
                        ...
                        <div class="timeline_content">
                            New comment on post <a href="#"><strong>Maiores sequi placeat.</strong></a>
                            <div class="timeline_content_addon">
                                <blockquote>
                                    Qui tempora sapiente blanditiis alias et mollitia quae sed at neque commodi et.&hellip;
                                </blockquote>
                            </div>
                        </div>
                    </div>
                                ...
                                <ul class="md-list md-list-addon">
                                    <li>
                                        ...
                                        <div class="md-list-content">
                                            <span class="md-list-heading">Corrine Kub</span>
                                            <span class="uk-text-small uk-text-muted">Nostrum sint officiis nisi libero.</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                ...
                <ul class="md-list md-list-addon chat_users">
                    <li>
                        ...
                        <div class="md-list-content">
                            ...
                            <span class="md-list-heading">Sydnie McCullough</span>
                            <span class="uk-text-small uk-text-muted uk-text-truncate">Error a quia.</span>
                        </div>
                    </li>
                    <li>
                        <div class="md-list-addon-element">
                        ...
                        <div class="md-list-content">
                            <div class="md-list-action-placeholder"></div>
                            <span class="md-list-heading">Ofelia Gerhold</span>
                            <span class="uk-text-small uk-text-muted uk-text-truncate">Aut sint molestias.</span>
                        </div>
                    </li>
                    <li>
                        <div class="md-list-addon-element">
                        ...
                        <div class="md-list-content">
                            <div class="md-list-action-placeholder"></div>
                            <span class="md-list-heading">Estell Pagac</span>
                            <span class="uk-text-small uk-text-muted uk-text-truncate">Ea sed.</span>
                        </div>
                    </li>
                    <li>
                        <div class="md-list-addon-element">
                        ...
                        <div class="md-list-content">
                            <div class="md-list-action-placeholder"></div>
                            <span class="md-list-heading">Fanny Gislason</span>
                            <span class="uk-text-small uk-text-muted uk-text-truncate">Commodi quia cumque.</span>
                        </div>
                    </li>
                </ul>
